...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function displaySelectedGraphRegion(start, end) {
    ...
    const width =
      start < end ? wid - xLoc - margins.right : xLoc - margins.left;
      ...
      if (baselineNum >= 0 && baselineNum <= 1) {
        if (greaterOrLessThan == "greater") {
          ...
          outputText.innerText =
            ...
            amountGreaterThan +
            " samples (" +
            (amountGreaterThan / populationHistory.length).toFixed(2) +
          ...
          outputText.innerText =
            ...
            amountLessThan +
            " samples (" +
            (amountLessThan / populationHistory.length).toFixed(2) +
            ") in the selected region.";
