...
const graphTitles = {
    ...
    b: "Average Enjoyment (Stratified by Rows)",
    c: "Average Enjoyment (Stratified by Columns"
};

const assets = {
    images: {
        fanDefault: "../ASSETS/fanDefaultTSWIFT.png",
        fanSelected: "../ASSETS/fanSelectedTSWIFT.png"
    }
};
...
function displayEntries(entries){
    for(let i = 0; i < 50; i++){
        ...
        if(entries.includes(i)){
            associatedImage.src = assets.images.fanSelected;
        } else{
            associatedImage.src = assets.images.fanDefault;
        }
    }
